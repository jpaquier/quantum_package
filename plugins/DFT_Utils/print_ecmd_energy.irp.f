...
!write(*, '(A28,X,F16.10)') 'on_top_PBE_cor MD correl  = ',Energy_c_md_on_top_PBE_mu_corrected_UEG(1)
 write(*, '(A28,X,F16.10)') 'on_top_PBE_cor MD bis     = ',Energy_c_md_on_top_PBE_mu_corrected_UEG_vector(1)
!write(*, '(A28,X,F16.10)') 'on_top_PBE_cor MD correl  = ',Energy_c_md_on_top_PBE_mu_corrected(1)
 write(*, '(A28,X,F16.10)') 'on_top_PBE_cor MD bis     = ',Energy_c_md_on_top_PBE_mu_corrected_vector(1)
...
subroutine ecmd_energy_printer
 ...
 write(*, '(A22,X,F16.10)') 'EC_MD_ON_TOP_UEG    = ',Energy_c_md_on_top_PBE_mu_corrected_UEG_vector(1)+psi_energy+nuclear_repulsion
 write(*, '(A22,X,F16.10)') 'EC_MD_ON_TOP_NO UEG = ',Energy_c_md_on_top_PBE_mu_corrected_vector(1)+psi_energy+nuclear_repulsion
 print*, ''
 ...
 write(*, '(A28,X,F16.10)') 'on_top_PBE_cor UEG        = ',Energy_c_md_on_top_PBE_mu_corrected_UEG_vector(1)
 write(*, '(A28,X,F16.10)') 'on_top_PBE_cor NO UEG     = ',Energy_c_md_on_top_PBE_mu_corrected_vector(1)
