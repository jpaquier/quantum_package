...
subroutine give_epsilon_c_md_on_top_PBE_mu_corrected_UEG_from_two_dm(mu,r,two_dm,eps_c_md_on_top_PBE)
 ...
 BEGIN_PROVIDER [double precision, Energy_c_md_on_top_PBE_mu_corrected_UEG_vector, (N_states)]
 BEGIN_DOC
  ! Give the Ec_md energy with a good large mu behaviour in function of the on top pair density with mu correction based on the on-top of the UEG coupled to the PBE correlation energy at mu=0
  ! Ec_md_on_top_PBE = Int epsilon_c_PBE_mu=0 / ( 1 + beta*mu**3 ) = Int eps_c_md_on_top_PBE  with beta chosen to recover the good large mu behaviour of the Energy_c_md_on_top functional
 END_DOC
 ...
 mu = mu_erf
 Energy_c_md_on_top_PBE_mu_corrected_UEG_vector = 0.d0
 ...
 do i = 1, n_points_final_grid
  ...
  do istate = 1, N_states
   Energy_c_md_on_top_PBE_mu_corrected_UEG_vector(istate) += eps_c_md_on_top_PBE(istate) * weight
  enddo
 enddo
 END_PROVIDER

 BEGIN_PROVIDER [double precision, Energy_c_md_on_top_PBE_mu_corrected_vector, (N_states)]
 BEGIN_DOC
  ! Give the Ec_md energy with a good large mu behaviour in function of the on top pair density with mu correction based on the on-top of the UEG coupled to the PBE correlation energy at mu=0
  ! Ec_md_on_top_PBE = Int epsilon_c_PBE_mu=0 / ( 1 + beta*mu**3 ) = Int eps_c_md_on_top_PBE  with beta chosen to recover the good large mu behaviour of the Energy_c_md_on_top functional
 END_DOC
 ...
 allocate(eps_c_md_on_top_PBE(N_states),two_dm(N_states))
 mu = mu_erf
 Energy_c_md_on_top_PBE_mu_corrected_vector = 0.d0
 ...
 do i = 1, n_points_final_grid
  ...
  do istate = 1, N_states
   Energy_c_md_on_top_PBE_mu_corrected_vector(istate) += eps_c_md_on_top_PBE(istate) * weight
  enddo
 enddo
 END_PROVIDER
