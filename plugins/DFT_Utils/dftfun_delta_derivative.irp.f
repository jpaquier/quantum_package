 ...
 BEGIN_DOC
  ! Derivative of denominator_delta 
 END_DOC
 implicit none
 ...
 BEGIN_DOC
  ! Derivative of delta_2*mu**2/(1+d0**2*mu**2)**4 (1st part of equation 42 of Panziani et al, PRB 73, 155111 (2006))
 END_DOC
 implicit none
...
!!!!!!!!2nd terms!!!!!
 ...
 BEGIN_DOC
  ! Derivative of delta_3*mu**3/(1+d0**2*mu**2)**4 (2nd part of equation 42 of Panziani et al, PRB 73, 155111 (2006))
 END_DOC
 implicit none
...
!!!!!!!!third terms!!!!!
 ...
 BEGIN_DOC
  ! Derivative of capital_c4_delta
 END_DOC
 implicit none
...
double precision function delta_4(rs,xi)
 ...
 BEGIN_DOC
  ! Derivative of delta_4*mu**4/(1+d0**2*mu**2)**4 (3rd part of equation 42 of Panziani et al, PRB 73, 155111 (2006))
 END_DOC
 implicit none
...
!!!!!!!!fourth term!!!!!
 ...
 BEGIN_DOC
  ! Derivative of delta_5*mu**5/(1+d0**2*mu**2)**4 (4th part of equation 42 of Panziani et al, PRB 73, 155111 (2006))
 END_DOC
 implicit none
...
!!!!!!!!fifth term!!!!!
 ...
 BEGIN_DOC
  ! Derivative of delta_6*mu**6/(1+d0**2*mu**2)**4 (5th part of equation 42 of Panziani et al, PRB 73, 155111 (2006))
 END_DOC
 implicit none
...
!!!!!!!!DELTA TOTAL ET DERIVATIVE!!!!!!!
 ...
 BEGIN_DOC
  ! Derivative of eq 42 of Panziani et al, PRB 73, 155111 (2006) 
 END_DOC
 implicit none
...
!!!!!!!!!!!! CORRELATION PART
      ...
      Energy_c_md_LDA_barth(istate) += final_weight_functions_at_grid_points(l,k,j) * ec(istate)
     enddo
    enddo
   enddo
  enddo
