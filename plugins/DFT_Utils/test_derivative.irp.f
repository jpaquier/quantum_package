...
!!!!!!!!!!!!!!!!!testsss delta2!!!!!!!!!
    ...
    accu_2 += dabs(d_delta_barth_bis_2 - d_xi_1st_deltaterm(rs,mu,xi)*dxi_dna)*final_weight_functions_at_grid_points(l,k,j)
!!!!!!!!!!!!!!!!!testsss delta3!!!!!!!!!
    ...
    accu_3 += dabs(d_delta_barth_bis_3-d_xi_2nd_deltaterm(rs,mu,xi)*dxi_dna)*final_weight_functions_at_grid_points(l,k,j)
!!!!!!!!!!!!!!!!!TEST delta_4!!!!!!!!!
    ...
    accu_4 += dabs(d_delta_barth_bis_4-d_xi_3rd_deltaterm(rs,mu,xi)*dxi_dna)*final_weight_functions_at_grid_points(l,k,j)
!!!!!!!!!!!!!!!!!TEST delta_5!!!!!!!!!
    ...
    accu_5 += dabs(d_delta_barth_bis_5-d_xi_4th_deltaterm(rs,mu,xi)*dxi_dna)*final_weight_functions_at_grid_points(l,k,j)
!!!!!!!!!!!!!!!!!TEST delta_6!!!!!!!!!
    ...
    accu_6 += dabs(d_delta_barth_bis_6-d_xi_5th_deltaterm(rs,mu,xi)*dxi_dna)*final_weight_functions_at_grid_points(l,k,j)
!!!!!!!!!!!!!!!!!TOTAL TEST!!!!!!!!!
    ...
    accu += dabs(d_delta_barth_bis - d_xi_delta_barth(rs,xi,mu)*dxi_dna)*final_weight_functions_at_grid_points(l,k,j)
    enddo
   enddo
  enddo
...
!!!!!!!!!!!!!!!!!ALPHA!!!!!!!!!
    ...
    accu += dabs(d_delta_barth_bis - (d_delta_barth(rs,xi,mu)*drs+d_xi_delta_barth(rs,xi,mu)*dxi_dna))*final_weight_functions_at_grid_points(l,k,j)
...
!!!!!!!!!!!!!!!!!BETA!!!!!!!!!
    ...
    accu_2 += dabs(d_delta_barth_bis - (d_delta_barth(rs,xi,mu)*drs+d_xi_delta_barth(rs,xi,mu)*dxi_dnb))*final_weight_functions_at_grid_points(l,k,j)
...
!!!!!!!!!!!!!!!!!ALPHA!!!!!!!!!
    ...
    accu += dabs(d_delta_barth_bis - d_total_deltarho_rhoa(rhoa,rhob,mu))*final_weight_functions_at_grid_points(l,k,j)
...
!!!!!!!!!!!!!!!!!BETA!!!!!!!!!
    ...
    accu_2 += dabs(d_delta_barth_bis - d_total_deltarho_rhob(rhoa,rhob,mu))*final_weight_functions_at_grid_points(l,k,j)
