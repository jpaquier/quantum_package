 BEGIN_PROVIDER [ integer, large_ao_num ]
  implicit none
  BEGIN_DOC
  ! Number of large component gaussian
  END_DOC  
 large_ao_num = ao_num
 END_PROVIDER
 ...
 !component aos. large_ao_ortho_canonical_coef(i,j) = coefficient of the ith ao on the jth
 ...
 BEGIN_PROVIDER [ double precision, large_mo_coef, (large_ao_num,large_mo_tot_num) ]
  ...
  ! large_mo_coef(i,j) = coefficient of the ith small component ao on the jth
  ! small component mo
