...
!print*,''
!print*,'small_ao_num =', ao_num
!do i = 1, ao_num
! print*,''
! print*,'***************************************************'
! print*,'ao_power =', ao_power(i,1), ao_power(i,2), ao_power(i,3)
! print*,'ao_coef_normalized_ordered =', ao_coef_normalized_ordered(i,1) 
! do j= 1, ao_num 
!  print*,'ao_power =', ao_power(j,1), ao_power(j,2), ao_power(j,3)
!  print*,'ao_overlap_x =', ao_overlap_x(i,j)
!  print*,'ao_overlap_y =', ao_overlap_y(i,j)
!  print*,'ao_overlap_z =', ao_overlap_z(i,j)
