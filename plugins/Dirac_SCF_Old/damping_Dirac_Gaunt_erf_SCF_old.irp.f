!subroutine damping_dirac_Gaunt_erf_SCF
! implicit none
...
! write(6,'(A4,1X,A16, 1X, A16, 1X, A16, 1X, A4 )')  &
!   '====','================','================','================', '===='
! E = dirac_SCF_Gaunt_erf_energy + 1.d0
! E_min = dirac_SCF_Gaunt_erf_energy
! delta_D_complex = (0.d0,0.d0)
! delta_D = 0.d0
! do k=1,n_it_scf_max
!  delta_E = dirac_SCF_Gaunt_erf_energy - E
!  E = dirac_SCF_Gaunt_erf_energy
...
!   k, dirac_SCF_Gaunt_erf_energy, delta_E, delta_D, save_char
!  D = dirac_SCF_density_matrix_ao
!  dirac_mo_coef = eigenvectors_dirac_fock_matrix_Gaunt_erf_ao
!  TOUCH dirac_mo_coef
!  D_new = dirac_SCF_density_matrix_ao
!  F_new = dirac_Fock_matrix_Gaunt_erf_ao
!  E_new = dirac_SCF_Gaunt_erf_energy
!  delta = D_new - D
!  lambda = .5d0
!  E_half = 0.d0
!  do while (E_half > E)
...
!   dirac_mo_coef = eigenvectors_dirac_fock_matrix_Gaunt_erf_ao
!   TOUCH dirac_mo_coef
!   E_half = dirac_SCF_Gaunt_erf_energy
...
! write(6,'(A4,1X,A16, 1X, A16, 1X, A16, 1X, A4 )')  '====','================','================','================', '===='
! write(6,*)
! call write_double(6, dirac_SCF_Gaunt_erf_energy, 'Long-range Coulomb-Gaunt Hartree-Fock energy')
