subroutine reorder_wf
 ...
 integer :: i,j,k,l
 integer :: index_ref_generators_restart, degree,N_det_non_ref
 ...
 do k = 1, N_int
  psi_det(k,1,1) = psi_det_tmp(k,1,index_ref_generators_restart) 
  psi_det(k,2,1) = psi_det_tmp(k,2,index_ref_generators_restart) 
 enddo
 do k = 1, N_states
  psi_coef(1,k) = psi_coef_tmp(index_ref_generators_restart,k)
 enddo
 ...
 do i = 1, N_det
  ...
  if(i==index_ref_generators_restart)cycle
  j+=1 
  do k = 1, N_int
