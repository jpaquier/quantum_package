program Dirac_AO_Basis
 ...
 do j=1,nucl_num
  ...
  !print*,i,j,Nucl_dirac_Aos_transposed(i,j), dirac_ao_power_ordered_transp_per_nucl(1,i,j),dirac_ao_power_ordered_transp_per_nucl(2,i,j),dirac_ao_power_ordered_transp_per_nucl(3,i,j)
  enddo
 !print*,'******************'
 enddo
