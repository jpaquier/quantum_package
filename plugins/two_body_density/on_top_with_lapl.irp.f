subroutine spherical_averaged_two_dm_at_second_order(r1,r12,istate,two_dm,two_dm_laplacian,total_dm)
 ...
 integer :: i,j,k,l,ix
 double precision :: lapl_k,lapl_l,scalar_grad
  ...
  do j = 1, mo_tot_num
   do k = 1, mo_tot_num
    ...
    do l = 1, mo_tot_num
     ...
     if(dabs(two_bod_alpha_beta_mo_transposed(l,k,j,i,istate)).gt.0.d0)then
      print*,'lapl_k,scalar_grad,lapl_l'
      print*,lapl_k,scalar_grad,lapl_l
      print*,'k'
      print*,mos_lapl_array_r1(k,1),mos_lapl_array_r1(k,2),mos_lapl_array_r1(k,3)
      print*,'l'
      print*,mos_lapl_array_r1(l,1),mos_lapl_array_r1(l,2),mos_lapl_array_r1(l,3)
     endif
    enddo
   enddo
  enddo
