...
! j_real = list_core_inact(j_virt)
 ...
 call cpu_time(cpu1) 
 print*, 'Time to transform occ-virt-virt  =',cpu1-cpu0
...
! j_real = list_core_inact(j_virt)
 ...
 call cpu_time(cpu1) 
 print*, 'Time to transform virt1_occ2_occ2  =',cpu1-cpu0
...
! j_real = list_core_inact(j_virt)
 ...
 call cpu_time(cpu1) 
 print*, 'Time to transform occ-virt-occ  =',cpu1-cpu0
...
!  bielec_tmp_0(1:ao_num,1:ao_num) = semi_transformed_occ_virt(1:ao_num,1:ao_num,j,i)
 ...
 call cpu_time(cpu1) 
 print*, 'Time to transform occ-virt  =',cpu1-cpu0
