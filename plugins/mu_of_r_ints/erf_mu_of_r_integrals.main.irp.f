...
!call test_int_erf_bielec_ijkl_mo
 ...
 double precision :: get_ao_bielec_integral_erf_mu_of_r,get_ao_bielec_integral_erf_mu_of_r_left, erf_mu_of_r_ao
 do i =1, ao_num!1
  do j = 1, ao_num!2
   do k = 1, ao_num!1
    do l =1,  ao_num!2
     integral   =get_ao_bielec_integral_erf_mu_of_r(i,j,k,l,ao_integrals_erf_mu_of_r_map)
     integral_2 =get_ao_bielec_integral_erf_mu_of_r_left(i,j,k,l,ao_integrals_erf_mu_of_r_map)
     integral_3 = erf_mu_of_r_ao(i,k,j,l) 
     if(dabs(0.5D0 * (integral + integral_2) - integral_3) .GT.1.d-10)then
      print*,'integral, integral_left'
      print*,0.5D0 * (integral + integral_2),integral , integral_2  
      print*,integral_3
     endif
    enddo
   enddo
