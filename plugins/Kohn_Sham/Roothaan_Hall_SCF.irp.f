...
! Current size of the DIIS space
   ...
   !SCF energy
    ...
    energy_SCF = KS_energy
    print*,'KS_energy main =',KS_energy
    ...
    do while (Delta_Energy_SCF > 0.d0)
      ...
      Delta_Energy_SCF = KS_energy - energy_SCF_previous
      print*,'KS_energy = ',KS_energy,Delta_Energy_SCF
      energy_SCF = KS_energy
