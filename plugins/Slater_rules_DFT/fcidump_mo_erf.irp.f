...
subroutine routine
  ...
  double precision :: get_mo_bielec_integral_erf, integral_erf
! double precision :: get_mo_bielec_integral_sr, integral_sr
   ...
   do k=1,n_act_orb
    ...
    do j=l,n_act_orb
     ...
     do i=k,n_act_orb
      i1 = list_act(i)
       if (i1>=j1) then
          integral_erf = get_mo_bielec_integral_erf(i1,j1,k1,l1,mo_integrals_erf_map)
!         integral_sr = get_mo_bielec_integral_sr(i1,j1,k1,l1,mo_integrals_sr_map)
...
!          pause
!         endif
          if (dabs(integral_erf) > mo_integrals_threshold) then 
