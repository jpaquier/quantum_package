subroutine u_0_H_u_0_erf(e_0,u_0,n,keys_tmp,Nint,N_st,sze_8)
  use bitmasks
  implicit none
  BEGIN_DOC
  ...
  call H_S2_u_0_nstates_openmp_erf(v_0,s_0,u_0,N_st,sze_8)
  do i=1,N_st
...
subroutine u_0_H_u_0_mono(e_0,u_0,n,keys_tmp,Nint,N_st,sze_8)
  use bitmasks
  implicit none
  BEGIN_DOC
  ! Computes e_0 = <u_0|H|u_0>/<u_0|u_0>
  ...
  integer :: i,j
  allocate (v_0(sze_8,N_st),s_0(sze_8,N_st))
  call H_S2_u_0_nstates_openmp_work_mono(v_0,s_0,u_0,N_st,sze_8)
  do i=1,N_st
    e_0(i) = u_dot_v(v_0(1,i),u_0(1,i),n)/u_dot_u(u_0(1,i),n)
  enddo
  deallocate (s_0, v_0)
...
subroutine u_0_H_u_0_hartree(e_0,u_0,n,keys_tmp,Nint,N_st,sze_8)
  use bitmasks
  implicit none
  BEGIN_DOC
  ! Computes e_0 = <u_0|H|u_0>/<u_0|u_0>
  ...
  integer :: i,j
  allocate (v_0(sze_8,N_st),s_0(sze_8,N_st))
  call H_S2_u_0_nstates_openmp_work_hartree(v_0,s_0,u_0,N_st,sze_8)
  do i=1,N_st
    e_0(i) = u_dot_v(v_0(1,i),u_0(1,i),n)/u_dot_u(u_0(1,i),n)
  enddo
  deallocate (s_0, v_0)
...
subroutine H_S2_u_0_nstates_openmp_erf(v_0,s_0,u_0,N_st,sze_8)
  use bitmasks
  implicit none
  BEGIN_DOC
  ...
  call H_S2_u_0_nstates_openmp_work_erf(v_0,s_0,u_t,N_st,sze_8,1,N_det,0,1)
  deallocate(u_t)
...
subroutine H_S2_u_0_nstates_openmp_work_erf(v_0,s_0,u_t,N_st,sze_8,istart,iend,ishift,istep)
  use bitmasks
  implicit none
  BEGIN_DOC
  ! Computes v_0 = H|u_0> and s_0 = S^2 |u_0>
...
subroutine H_S2_u_0_nstates_openmp_work_mono(v_0,s_0,u_t,N_st,sze_8,istart,iend,ishift,istep)
  use bitmasks
  implicit none
  BEGIN_DOC
  ! Computes v_0 = H|u_0> and s_0 = S^2 |u_0>
  ...
  do k_a=istart+ishift,iend,istep
    ...
    do i=1,n_singles
      ...
      lrow = psi_bilinear_matrix_rows(l_a)
      tmp_det2(1:N_int,1) = psi_det_alpha_unique(1:N_int, lrow)
      call i_H_j_mono_spin_mono( tmp_det, tmp_det2, N_int, 1, hij)
      do l=1,N_st
        v_t(l,l_a) = v_t(l,l_a) + hij * u_t(l,k_a)
        v_t(l,k_a) = v_t(l,k_a) + hij * u_t(l,l_a)
        ! single => sij = 0 
    ...
    do i=1,n_singles
      ...
      lcol = psi_bilinear_matrix_transp_columns(l_b)
      tmp_det2(1:N_int,2) = psi_det_beta_unique (1:N_int, lcol)
      call i_H_j_mono_spin_mono( tmp_det, tmp_det2, N_int, 2, hij)
      l_a = psi_bilinear_matrix_transp_order(l_b)
      do l=1,N_st
        v_t(l,l_a) = v_t(l,l_a) + hij * u_t(l,k_a)
        v_t(l,k_a) = v_t(l,k_a) + hij * u_t(l,l_a)
    ...
    double precision, external :: diag_H_mat_elem_mono, diag_S_mat_elem
  
    hij = diag_H_mat_elem_mono(tmp_det,N_int) 
    sij = diag_S_mat_elem(tmp_det,N_int)
    do l=1,N_st
      v_t(l,k_a) = v_t(l,k_a) + hij * u_t(l,k_a)
      s_t(l,k_a) = s_t(l,k_a) + sij * u_t(l,k_a)
...
subroutine H_S2_u_0_nstates_openmp_work_hartree(v_0,s_0,u_t,N_st,sze_8,istart,iend,ishift,istep)
  use bitmasks
  implicit none
  BEGIN_DOC
  ! Computes v_0 = H|u_0> and s_0 = S^2 |u_0>
  ...
  do k_a=istart+ishift,iend,istep
    ...
    do i=1,n_singles
      ...
      lrow = psi_bilinear_matrix_rows(l_a)
      tmp_det2(1:N_int,1) = psi_det_alpha_unique(1:N_int, lrow)
      call i_H_j_mono_spin_hartree( tmp_det, tmp_det2, N_int, 1, hij)
      do l=1,N_st
        v_t(l,l_a) = v_t(l,l_a) + hij * u_t(l,k_a)
        v_t(l,k_a) = v_t(l,k_a) + hij * u_t(l,l_a)
        ! single => sij = 0 
    ...
    do i=1,n_singles
      ...
      lcol = psi_bilinear_matrix_transp_columns(l_b)
      tmp_det2(1:N_int,2) = psi_det_beta_unique (1:N_int, lcol)
      call i_H_j_mono_spin_hartree( tmp_det, tmp_det2, N_int, 2, hij)
      l_a = psi_bilinear_matrix_transp_order(l_b)
      do l=1,N_st
        v_t(l,l_a) = v_t(l,l_a) + hij * u_t(l,k_a)
        v_t(l,k_a) = v_t(l,k_a) + hij * u_t(l,l_a)
    ...
    double precision, external :: diag_H_mat_elem_hartree, diag_S_mat_elem
  
    hij = diag_H_mat_elem_hartree(tmp_det,N_int) 
    sij = diag_S_mat_elem(tmp_det,N_int)
    do l=1,N_st
      v_t(l,k_a) = v_t(l,k_a) + hij * u_t(l,k_a)
      s_t(l,k_a) = s_t(l,k_a) + sij * u_t(l,k_a)
