 ...
 !Choose Interaction
  if (dirac_interaction == "Coulomb") then
   ...
   print*, 'mu_erf =',mu_erf
   print*, 'dirac_HF_two_electron_C_Exchange_energy=', dirac_HF_two_electron_C_Exchange_energy
   open (10, file='Exchange_DHF_LRC.dat',position ='append') 
   write(10,*) mu_erf, dirac_HF_two_electron_C_Exchange_energy
  elseif (dirac_interaction == "Coulomb_Gaunt") then
   print*,'**********'
   print*,'Long-range Coulomb-Gaunt interaction'
   print*, 'mu_erf =',mu_erf
   print*, 'dirac_HF_two_electron_C_G_Exchange_energy=', dirac_HF_two_electron_C_G_Exchange_energy
   open (10, file='Exchange_DHF_LRCG.dat', position='append')
   write(10,*) mu_erf, dirac_HF_two_electron_C_G_Exchange_energy
  else
