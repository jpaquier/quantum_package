...
integer function number_of_holes(key_in)
 ...
 if(N_int == 1)then
   ...
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(4,1), xor(key_in(4,1),iand(key_in(4,1),act_bitmask(4,1)))), reunion_of_core_inact_bitmask(4,1)) )&   
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(4,2), xor(key_in(4,2),iand(key_in(4,2),act_bitmask(4,2)))), reunion_of_core_inact_bitmask(4,2)) )& 
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(5,1), xor(key_in(5,1),iand(key_in(5,1),act_bitmask(5,1)))), reunion_of_core_inact_bitmask(5,1)) )&   
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(5,2), xor(key_in(5,2),iand(key_in(5,2),act_bitmask(5,2)))), reunion_of_core_inact_bitmask(5,2)) ) 
   ...
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(5,1), xor(key_in(5,1),iand(key_in(5,1),act_bitmask(5,1)))), reunion_of_core_inact_bitmask(5,1)) )&   
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(5,2), xor(key_in(5,2),iand(key_in(5,2),act_bitmask(5,2)))), reunion_of_core_inact_bitmask(5,2)) )&
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(6,1), xor(key_in(6,1),iand(key_in(6,1),act_bitmask(6,1)))), reunion_of_core_inact_bitmask(6,1)) )&   
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(6,2), xor(key_in(6,2),iand(key_in(6,2),act_bitmask(6,2)))), reunion_of_core_inact_bitmask(6,2)) ) 
   ...
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(6,1), xor(key_in(6,1),iand(key_in(6,1),act_bitmask(6,1)))), reunion_of_core_inact_bitmask(6,1)) )&   
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(6,2), xor(key_in(6,2),iand(key_in(6,2),act_bitmask(6,2)))), reunion_of_core_inact_bitmask(6,2)) )&
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(7,1), xor(key_in(7,1),iand(key_in(7,1),act_bitmask(7,1)))), reunion_of_core_inact_bitmask(7,1)) )&   
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(7,2), xor(key_in(7,2),iand(key_in(7,2),act_bitmask(7,2)))), reunion_of_core_inact_bitmask(7,2)) ) 
   ...
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(6,1), xor(key_in(6,1),iand(key_in(6,1),act_bitmask(6,1)))), reunion_of_core_inact_bitmask(6,1)) )&   
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(6,2), xor(key_in(6,2),iand(key_in(6,2),act_bitmask(6,2)))), reunion_of_core_inact_bitmask(6,2)) )&
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(8,1), xor(key_in(8,1),iand(key_in(8,1),act_bitmask(8,1)))), reunion_of_core_inact_bitmask(8,1)) )&   
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(8,2), xor(key_in(8,2),iand(key_in(8,2),act_bitmask(8,2)))), reunion_of_core_inact_bitmask(8,2)) ) 
 else
   do i = 1, N_int
    number_of_holes = number_of_holes  & 
   ...
   + popcnt( xor( iand(reunion_of_core_inact_bitmask(i,1), xor(key_in(i,2),iand(key_in(i,2),act_bitmask(i,1)))), reunion_of_core_inact_bitmask(i,1)) )
   enddo
 endif
end
...
integer function number_of_particles(key_in)
 ...
 if(N_int == 1)then
   ...
   number_of_particles= number_of_particles                                                                                  & 
      + popcnt( iand( iand( xor(key_in(1,1),iand(key_in(1,1),act_bitmask(1,1))), virt_bitmask(1,1) ), virt_bitmask(1,1)) ) & 
      + popcnt( iand( iand( xor(key_in(1,2),iand(key_in(1,2),act_bitmask(1,2))), virt_bitmask(1,2) ), virt_bitmask(1,2)) ) &
      + popcnt( iand( iand( xor(key_in(2,1),iand(key_in(2,1),act_bitmask(2,1))), virt_bitmask(2,1) ), virt_bitmask(2,1)) ) & 
      + popcnt( iand( iand( xor(key_in(2,2),iand(key_in(2,2),act_bitmask(2,2))), virt_bitmask(2,2) ), virt_bitmask(2,2)) ) 
 else if(N_int == 3)then
   number_of_particles= number_of_particles                                                                                  & 
      + popcnt( iand( iand( xor(key_in(1,1),iand(key_in(1,1),act_bitmask(1,1))), virt_bitmask(1,1) ), virt_bitmask(1,1)) ) & 
      + popcnt( iand( iand( xor(key_in(1,2),iand(key_in(1,2),act_bitmask(1,2))), virt_bitmask(1,2) ), virt_bitmask(1,2)) ) &
      + popcnt( iand( iand( xor(key_in(2,1),iand(key_in(2,1),act_bitmask(2,1))), virt_bitmask(2,1) ), virt_bitmask(2,1)) ) & 
      + popcnt( iand( iand( xor(key_in(2,2),iand(key_in(2,2),act_bitmask(2,2))), virt_bitmask(2,2) ), virt_bitmask(2,2)) ) &
      + popcnt( iand( iand( xor(key_in(3,1),iand(key_in(3,1),act_bitmask(3,1))), virt_bitmask(3,1) ), virt_bitmask(3,1)) ) & 
      + popcnt( iand( iand( xor(key_in(3,2),iand(key_in(3,2),act_bitmask(3,2))), virt_bitmask(3,2) ), virt_bitmask(3,2)) ) 
 else if(N_int == 4)then
   number_of_particles= number_of_particles                                                                                  & 
      + popcnt( iand( iand( xor(key_in(1,1),iand(key_in(1,1),act_bitmask(1,1))), virt_bitmask(1,1) ), virt_bitmask(1,1)) ) & 
      + popcnt( iand( iand( xor(key_in(1,2),iand(key_in(1,2),act_bitmask(1,2))), virt_bitmask(1,2) ), virt_bitmask(1,2)) ) &
      ...
      + popcnt( iand( iand( xor(key_in(3,1),iand(key_in(3,1),act_bitmask(3,1))), virt_bitmask(3,1) ), virt_bitmask(3,1)) ) & 
      + popcnt( iand( iand( xor(key_in(3,2),iand(key_in(3,2),act_bitmask(3,2))), virt_bitmask(3,2) ), virt_bitmask(3,2)) ) &
      + popcnt( iand( iand( xor(key_in(4,1),iand(key_in(4,1),act_bitmask(4,1))), virt_bitmask(4,1) ), virt_bitmask(4,1)) ) & 
      + popcnt( iand( iand( xor(key_in(4,2),iand(key_in(4,2),act_bitmask(4,2))), virt_bitmask(4,2) ), virt_bitmask(4,2)) ) 
 else if(N_int == 5)then
   number_of_particles= number_of_particles                                                                                  & 
      + popcnt( iand( iand( xor(key_in(1,1),iand(key_in(1,1),act_bitmask(1,1))), virt_bitmask(1,1) ), virt_bitmask(1,1)) ) & 
      + popcnt( iand( iand( xor(key_in(1,2),iand(key_in(1,2),act_bitmask(1,2))), virt_bitmask(1,2) ), virt_bitmask(1,2)) ) &
      ...
      + popcnt( iand( iand( xor(key_in(4,1),iand(key_in(4,1),act_bitmask(4,1))), virt_bitmask(4,1) ), virt_bitmask(4,1)) ) & 
      + popcnt( iand( iand( xor(key_in(4,2),iand(key_in(4,2),act_bitmask(4,2))), virt_bitmask(4,2) ), virt_bitmask(4,2)) ) &
      + popcnt( iand( iand( xor(key_in(5,1),iand(key_in(5,1),act_bitmask(5,1))), virt_bitmask(5,1) ), virt_bitmask(5,1)) ) & 
      + popcnt( iand( iand( xor(key_in(5,2),iand(key_in(5,2),act_bitmask(5,2))), virt_bitmask(5,2) ), virt_bitmask(5,2)) ) 
 else if(N_int == 6)then
   number_of_particles= number_of_particles                                                                                  & 
      + popcnt( iand( iand( xor(key_in(1,1),iand(key_in(1,1),act_bitmask(1,1))), virt_bitmask(1,1) ), virt_bitmask(1,1)) ) & 
      + popcnt( iand( iand( xor(key_in(1,2),iand(key_in(1,2),act_bitmask(1,2))), virt_bitmask(1,2) ), virt_bitmask(1,2)) ) &
      ...
      + popcnt( iand( iand( xor(key_in(5,1),iand(key_in(5,1),act_bitmask(5,1))), virt_bitmask(5,1) ), virt_bitmask(5,1)) ) & 
      + popcnt( iand( iand( xor(key_in(5,2),iand(key_in(5,2),act_bitmask(5,2))), virt_bitmask(5,2) ), virt_bitmask(5,2)) ) &
      + popcnt( iand( iand( xor(key_in(6,1),iand(key_in(6,1),act_bitmask(6,1))), virt_bitmask(6,1) ), virt_bitmask(6,1)) ) & 
      + popcnt( iand( iand( xor(key_in(6,2),iand(key_in(6,2),act_bitmask(6,2))), virt_bitmask(6,2) ), virt_bitmask(6,2)) ) 
 else if(N_int == 7)then
   number_of_particles= number_of_particles                                                                                  & 
      + popcnt( iand( iand( xor(key_in(1,1),iand(key_in(1,1),act_bitmask(1,1))), virt_bitmask(1,1) ), virt_bitmask(1,1)) ) & 
      + popcnt( iand( iand( xor(key_in(1,2),iand(key_in(1,2),act_bitmask(1,2))), virt_bitmask(1,2) ), virt_bitmask(1,2)) ) &
      ...
      + popcnt( iand( iand( xor(key_in(6,1),iand(key_in(6,1),act_bitmask(6,1))), virt_bitmask(6,1) ), virt_bitmask(6,1)) ) & 
      + popcnt( iand( iand( xor(key_in(6,2),iand(key_in(6,2),act_bitmask(6,2))), virt_bitmask(6,2) ), virt_bitmask(6,2)) ) &
      + popcnt( iand( iand( xor(key_in(7,1),iand(key_in(7,1),act_bitmask(7,1))), virt_bitmask(7,1) ), virt_bitmask(7,1)) ) & 
      + popcnt( iand( iand( xor(key_in(7,2),iand(key_in(7,2),act_bitmask(7,2))), virt_bitmask(7,2) ), virt_bitmask(7,2)) )  
 else if(N_int == 8)then
   number_of_particles= number_of_particles                                                                                  & 
      + popcnt( iand( iand( xor(key_in(1,1),iand(key_in(1,1),act_bitmask(1,1))), virt_bitmask(1,1) ), virt_bitmask(1,1)) ) & 
      + popcnt( iand( iand( xor(key_in(1,2),iand(key_in(1,2),act_bitmask(1,2))), virt_bitmask(1,2) ), virt_bitmask(1,2)) ) &
      ...
      + popcnt( iand( iand( xor(key_in(7,1),iand(key_in(7,1),act_bitmask(7,1))), virt_bitmask(7,1) ), virt_bitmask(7,1)) ) & 
      + popcnt( iand( iand( xor(key_in(7,2),iand(key_in(7,2),act_bitmask(7,2))), virt_bitmask(7,2) ), virt_bitmask(7,2)) ) & 
      + popcnt( iand( iand( xor(key_in(8,1),iand(key_in(8,1),act_bitmask(8,1))), virt_bitmask(8,1) ), virt_bitmask(8,1)) ) & 
      + popcnt( iand( iand( xor(key_in(8,2),iand(key_in(8,2),act_bitmask(8,2))), virt_bitmask(8,2) ), virt_bitmask(8,2)) )  
 else
   do i = 1, N_int
   number_of_particles= number_of_particles                                                                                  & 
      + popcnt( iand( iand( xor(key_in(i,1),iand(key_in(i,1),act_bitmask(i,1))), virt_bitmask(i,1) ), virt_bitmask(i,1)) ) & 
      + popcnt( iand( iand( xor(key_in(i,2),iand(key_in(i,2),act_bitmask(i,2))), virt_bitmask(i,2) ), virt_bitmask(i,2)) ) 
   enddo
 endif
end
...
logical function is_a_two_holes_two_particles(key_in)
 ...
 if(N_int == 1)then
   ...
   i_diff = i_diff  &
    ...
    + popcnt( xor( iand(reunion_of_core_inact_bitmask(3,2), xor(key_in(3,2),iand(key_in(3,2),act_bitmask(3,2)))), reunion_of_core_inact_bitmask(3,2)) )  &
    + popcnt( iand( iand( xor(key_in(3,1),iand(key_in(3,1),act_bitmask(3,1))), virt_bitmask(3,1) ), virt_bitmask(3,1)) ) & 
    + popcnt( iand( iand( xor(key_in(4,2),iand(key_in(3,2),act_bitmask(3,2))), virt_bitmask(3,2) ), virt_bitmask(3,2)) ) &
    + popcnt( xor( iand(reunion_of_core_inact_bitmask(4,1), xor(key_in(4,1),iand(key_in(4,1),act_bitmask(4,1)))), reunion_of_core_inact_bitmask(4,1)) )  &   
    + popcnt( xor( iand(reunion_of_core_inact_bitmask(4,2), xor(key_in(4,2),iand(key_in(4,2),act_bitmask(4,2)))), reunion_of_core_inact_bitmask(4,2)) )  &
    + popcnt( iand( iand( xor(key_in(4,1),iand(key_in(4,1),act_bitmask(4,1))), virt_bitmask(4,1) ), virt_bitmask(4,1)) ) & 
    + popcnt( iand( iand( xor(key_in(4,2),iand(key_in(4,2),act_bitmask(4,2))), virt_bitmask(4,2) ), virt_bitmask(4,2)) ) 
