...
module Integrals_bielec_range_separated : sig
(* Generate type *)
   type t = 
     {
...
(* Generate type *)
  ...
  let get_default = Qpackage.get_ezfio_default "integrals_bielec_range_separated";;
...
(* Read snippet for threshold_ao *)
  let read_threshold_ao () =
    if not (Ezfio.has_integrals_bielec_range_separated_threshold_ao ()) then
       get_default "threshold_ao"
       |> Float.of_string
       |> Ezfio.set_integrals_bielec_range_separated_threshold_ao
    ;
    Ezfio.get_integrals_bielec_range_separated_threshold_ao ()
      |> Threshold.of_float
  ;;
...
(* Read snippet for disk_access_ao_integrals *)
  let read_disk_access_ao_integrals () =
    if not (Ezfio.has_integrals_bielec_range_separated_disk_access_ao_integrals ()) then
       get_default "disk_access_ao_integrals"
       |> String.of_string
       |> Ezfio.set_integrals_bielec_range_separated_disk_access_ao_integrals
    ;
    Ezfio.get_integrals_bielec_range_separated_disk_access_ao_integrals ()
...
(* Read snippet for disk_access_ao_integrals_standard *)
  let read_disk_access_ao_integrals_standard () =
    if not (Ezfio.has_integrals_bielec_range_separated_disk_access_ao_integrals_standard ()) then
       get_default "disk_access_ao_integrals_standard"
       |> String.of_string
       |> Ezfio.set_integrals_bielec_range_separated_disk_access_ao_integrals_standard
    ;
    Ezfio.get_integrals_bielec_range_separated_disk_access_ao_integrals_standard ()
      |> Disk_access.of_string
  ;;
...
(* Read snippet for disk_access_mo_integrals *)
  let read_disk_access_mo_integrals () =
    if not (Ezfio.has_integrals_bielec_range_separated_disk_access_mo_integrals ()) then
       get_default "disk_access_mo_integrals"
       |> String.of_string
       |> Ezfio.set_integrals_bielec_range_separated_disk_access_mo_integrals
    ;
    Ezfio.get_integrals_bielec_range_separated_disk_access_mo_integrals ()
      |> Disk_access.of_string
  ;;
...
(* Read snippet for disk_access_mo_integrals_standard *)
  let read_disk_access_mo_integrals_standard () =
    if not (Ezfio.has_integrals_bielec_range_separated_disk_access_mo_integrals_standard ()) then
       get_default "disk_access_mo_integrals_standard"
       |> String.of_string
       |> Ezfio.set_integrals_bielec_range_separated_disk_access_mo_integrals_standard
    ;
    Ezfio.get_integrals_bielec_range_separated_disk_access_mo_integrals_standard ()
      |> Disk_access.of_string
  ;;
...
(* Read snippet for direct *)
  let read_direct () =
    if not (Ezfio.has_integrals_bielec_range_separated_direct ()) then
       get_default "direct"
       |> Bool.of_string
       |> Ezfio.set_integrals_bielec_range_separated_direct
    ;
    Ezfio.get_integrals_bielec_range_separated_direct ()
  ;;
...
(* Read snippet for long_range *)
  let read_long_range () =
    if not (Ezfio.has_integrals_bielec_range_separated_long_range ()) then
       get_default "long_range"
       |> Bool.of_string
       |> Ezfio.set_integrals_bielec_range_separated_long_range
    ;
    Ezfio.get_integrals_bielec_range_separated_long_range ()
  ;;
...
(* Read snippet for threshold_mo *)
  let read_threshold_mo () =
    if not (Ezfio.has_integrals_bielec_range_separated_threshold_mo ()) then
       get_default "threshold_mo"
       |> Float.of_string
       |> Ezfio.set_integrals_bielec_range_separated_threshold_mo
    ;
    Ezfio.get_integrals_bielec_range_separated_threshold_mo ()
      |> Threshold.of_float
  ;;
...
(* Read snippet for mu_erf *)
  let read_mu_erf () =
    if not (Ezfio.has_integrals_bielec_range_separated_mu_erf ()) then
       get_default "mu_erf"
       |> Float.of_string
       |> Ezfio.set_integrals_bielec_range_separated_mu_erf
    ;
    Ezfio.get_integrals_bielec_range_separated_mu_erf ()
  ;;
...
(* Read snippet for no_ivvv_integrals *)
  let read_no_ivvv_integrals () =
    if not (Ezfio.has_integrals_bielec_range_separated_no_ivvv_integrals ()) then
       get_default "no_ivvv_integrals"
       |> Bool.of_string
       |> Ezfio.set_integrals_bielec_range_separated_no_ivvv_integrals
    ;
    Ezfio.get_integrals_bielec_range_separated_no_ivvv_integrals ()
  ;;
...
(* Read snippet for no_vvv_integrals *)
  let read_no_vvv_integrals () =
    if not (Ezfio.has_integrals_bielec_range_separated_no_vvv_integrals ()) then
       get_default "no_vvv_integrals"
       |> Bool.of_string
       |> Ezfio.set_integrals_bielec_range_separated_no_vvv_integrals
    ;
    Ezfio.get_integrals_bielec_range_separated_no_vvv_integrals ()
  ;;
...
(* Read snippet for no_vvvv_integrals *)
  let read_no_vvvv_integrals () =
    if not (Ezfio.has_integrals_bielec_range_separated_no_vvvv_integrals ()) then
       get_default "no_vvvv_integrals"
       |> Bool.of_string
       |> Ezfio.set_integrals_bielec_range_separated_no_vvvv_integrals
    ;
    Ezfio.get_integrals_bielec_range_separated_no_vvvv_integrals ()
  ;;
